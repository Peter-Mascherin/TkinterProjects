...
#so overall ttk tkinter is shit, stick with regular tkinter cant even style buttons properly with ttk
def buttonchange():
    print("bye bye")
    root.destroy()
...
fourthbutton = ttk.Button(root,text="Click me for Labels",command=lambda: makelabel(1)).grid(row=1,column=1,padx=padding,pady=padding)
